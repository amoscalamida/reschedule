...
class OriginalLessonValidator extends \TYPO3\CMS\Extbase\Validation\Validator\AbstractValidator
{
    ...
    {
        $originalLesson = $originalLesson->format("d.m.Y H:i");
        ...
        if (!in_array(date("H:i", strtotime($originalLesson)), array('07:30', '08:25', '09:20', '10:25', '11:20', '12:25', '13:20', '14:15', '15:10', '16:05', '16:55'))) {
